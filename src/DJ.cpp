...
DJ::DJ() 
{
	...
	//AllMusic_.resize(3);
	AllMusic_[0].setMusic("../../music/Komiku_-_20_-_SUPER_POUPI.ogg", "Komiku_-_20_-_SUPER_POUPI");
	AllMusic_[0].setMusic("../../music/Komiku_-_64_-_First_Dance.ogg", "Komiku_-_64_-_First_Dance");
}
